...
Start here for planning and technical context.
...
## Focused downstream plans

| Document | Purpose |
|----------|---------|
| [phase-4-multiplayer-plan.md](phase-4-multiplayer-plan.md) | Multiplayer-specific direction and later delivery order |

## Historical delivery notes

Files named `phase-*-plan.md` and `phase-*-delivery.md` are historical records for shipped or previously scoped slices. Keep them for context, PR writeups, and repo history, but use the living docs above as the current source of truth.
