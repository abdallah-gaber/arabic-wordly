...
|:---|:---|:---|:---:|:---:|
| **C1** | Keyboard letter coloring | Color used letters on keyboard (gray/gold/teal) — biggest QoL missing feature | S | 🔥🔥🔥 |
...
| **B3** | Keyboard overlap fix | Ensure keyboard never covers the active input row | S | 🔥🔥 |
